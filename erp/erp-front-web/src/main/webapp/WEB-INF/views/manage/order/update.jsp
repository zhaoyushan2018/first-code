...
<script>
    $(function() {
        ...
        var vm = new Vue({
            ...
            methods:{
                ...
                changeType:function(){
                    if(this.partsType.id){
                        $.get("/order/" + this.partsType.id + "/partsTypeId").done(function(response){
            ...
            mounted:function(){
                $.get("/order/service/serviceTypes").done(function(response){
                    vm.serviceTypes = response.data;
                }).error(function(err){
                    layer.msg("系统异常");
                });

                $.get("/order/parts/partsTypes").done(function(response){
                    vm.partsTypes = response.data;
                }).error(function(err){
                    layer.msg("系统异常");
                });

                $.get("/order/" + orderId + "/infoVo").done(function(resp){
