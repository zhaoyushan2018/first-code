            ...
            <div class="box">
                <div class="box-body">
                    <ul class="nav nav-tabs">
                        <li id="undone" class="${type == 'done' ? '' : 'active'}"><a href="/order/undone/unlist">未完成订单</a></li>
...
<script>
    $(function(){
        ...
        $("#pagination").twbsPagination({
            ...
            prev:'上一页',
            next:'下一页',
            href:"/order/undone/unlist?p={{number}}&startTime=" + startDate + "&endTime=" + endDate + "&licenceNo=" + encodeURIComponent('${param.licenceNo}') + "&tel=${param.tel}"
        });
