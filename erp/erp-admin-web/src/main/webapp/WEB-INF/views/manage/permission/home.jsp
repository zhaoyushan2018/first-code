                    ...
                    <table class="table tree">
                        ...
                        <c:forEach items="${permissionList}" var="permission">
                            <tr class="treegrid-${permission.id}
                                ...
                                <td>
                                    <a class="btn btn-primary btn-xs" href="/manage/permission/${permission.id}/update" title="编辑"><i class="fa fa-pencil"></i></a>
