        ...
        <section class="content">
            ...
            <div class="box">
                ...
                <ul class="nav nav-tabs">
                    <li id="undone" class="${type == 'done' ? '' : 'active'}"><a href="/fix/unDoneOrder">已接未完成任务</a></li>
                    <li id="done" class="${type == 'done' ? 'active' : ''}"><a href="/fix/donelistOrder">已完成维修任务</a></li>
                </ul>

                <c:choose>
                    <c:when test="${fixOrder.orderId != null}">
...
<script>
    $(function(){
        ...
        $("#doneBtn").click(function(){
            layer.confirm("确定已完成所有维修工作了吗?", function(){
                window.location.href = "/fix/${fixOrder.orderId}/doneFix";
            })
        });
